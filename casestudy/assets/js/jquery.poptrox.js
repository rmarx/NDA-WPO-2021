		...
		$.fn.poptrox = function(options) {
			...
			// Main
				...
				$this.find(settings.selector).each(function(index) {
					...
					var realIndex = queue.length - 1; // simply using [index] would cause ignored elements to also be counted, leading to wrong popups 
					...
					a
						...
						.on('click', function(e) {
							...
							$popup.trigger('poptrox_open', [realIndex] );
